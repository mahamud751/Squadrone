...
const Footer = () => {
    return (
        <div className="footer-main" style={{ marginTop: "120px" }}>

            <div className="row">
                <div className="col-lg-3 col-md-3 col-12 mt-5 text-center text-white">
                    <h5>CONTACT US</h5>
                    <br />
                ...
                <div className="col-lg-6 col-md-6 col-12 text-center text-white">
                    ...
                    <p className="text-center text-white">© Copyright © SquaDrone. All rights reserved.</p>
                </div>
                <div className="col-lg-3 col-md-3 mt-5 col-12">
